...
//		Time.timeScale = 0;
		...
		player1.localScale = new Vector3(2f, CharacterAbilityManager.paddleSizeMod[1], 1f);
		player2.position = new Vector3(paddleOffset, 0, -10);
		player2.localScale = new Vector3(2f, CharacterAbilityManager.paddleSizeMod[2], 1f);
